...
public class Archaeologist extends Character{
     ...
     * Postconditions:
     * Object Archaeologist is created
     * Constructor Of class Archeologists
     ...
     */
    public Archaeologist(Player player, String image, String ability, int is_used, String color , int counter){
